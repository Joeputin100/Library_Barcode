...
@pytest.mark.parametrize("query, expected_json", [
    ("barcode 12345", {"type": "barcode", "value": "12345"}),
    ("barcodes from b100 to b200", {"type": "barcode_range", "start": "100", "end": "200"}),
    ("barcodes starting with B", {"type": "barcode_starts_with", "prefix": "B"}),
    ("author: brandon sanderson", {"type": "field_query", "field": "author", "value": "brandon sanderson"}),
    ("all barcodes by Aveyard.", {"type": "field_query", "field": "author", "value": "Aveyard"}),
