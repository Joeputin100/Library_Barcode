...
def main():
    ...
    if uploaded_file:
        ...
        for i, row in df.iterrows():
            ...
            lc_meta = get_book_metadata_initial_pass(title, author, loc_cache, is_blank=is_blank_row, is_problematic=is_problematic_row)
            ...
            cleaned_original_call_number = clean_call_number(raw_original_call_number, [], [], title="", is_original_data=True)
        ...
        if unclassified_books_for_vertex_ai:
            ...
            for batch in batches:
                batch_classifications = get_vertex_ai_classification_batch(batch, vertex_ai_credentials, loc_cache)
